class DropBoxController {
  ...
  connectFirebase() {
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyBRy61_JBuBc4nVIkilGi11RQ0dNBsmRLI",
      authDomain: "dropbox-clone-7fcff.firebaseapp.com",
      databaseURL: "https://dropbox-clone-7fcff.firebaseio.com",
      projectId: "dropbox-clone-7fcff",
      storageBucket: "dropbox-clone-7fcff.appspot.com",
      messagingSenderId: "878651016044",
      appId: "1:878651016044:web:b9b1b658f7e84c9316a949",
      measurementId: "G-21T6J8GMZ1"
    };
    // Initialize Firebase
  ...
  initEvents() {
    this.btnNewFolder.addEventListener('click', e => {
      let name = prompt('Nome da nova página:');
      if(name) {
    ...
    this.listFilesEl.addEventListener('selectionchange', event => {
      ...
      switch (this.getSelection().length) {
        ...
        default:
          this.btnRname.style.display = 'none';
          this.btnDelete.style.display = 'block';
      }
